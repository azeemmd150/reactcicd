...
const FORM_VALIDATION = Yup.object().shape({
  ...
  emergencydetails: Yup.string().required("Required"),
  ...
  jobtitledesignation: Yup.string().required("Required"),
  joiningAndLeavingDate: Yup.mixed().required("Required"),
  empolyeeCode: Yup.mixed().required("Required"),
  grossSalary: Yup.mixed().required("Required"),
  typeOfEmployement: Yup.string().required("Required"),
  reasonforLeaving: Yup.string().required("Required"),
  hrName: Yup.string().required("Required"),
  hrcontactNo: Yup.string().required("Required"),
  hrmail: Yup.string().required("Required"),
          ...
          <div>
            <Formik
              ...
              onSubmit={(ee) => {
                console.log(ee);
                console.log(value);
                const res = axios.post(Urls.ExperiencePostUrl, ee
                );
            ...
            >
              <Form form method="post" action="#" id="#" onSubmit={pocSubmit}>
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={6}>
                    <Textfield name="emergencydetails" label="Emergency contact details:Name,Mobile No, Relation" />
                  </Grid>
                  ...
                  <Grid item xs={6}>
                    <Textfield name="jobtitledesignation" label="Job title/ Designation" />
                  </Grid>
                  <Grid item xs={6}>
                    <Textfield name="joiningAndLeavingDate" label="JOining and Leaving Date" />
                  </Grid>
                  <Grid item xs={6}>
                    <Textfield name="empolyeeCode" label="Employee code" />
                  </Grid>
                  <Grid item xs={6}>
                    <Textfield name="grossSalary" label="Gross salary" />
                  </Grid>
                  <Grid item xs={6}>
                    <Textfield name="typeOfEmployement" label="Type of Employement(Permanent/Contract/Temporary)" />
                  </Grid>
                  <Grid item xs={6}>
                  ...
                  <Grid item xs={12}>
                    <Typography>
                      <h4 align="left">HR Contact details</h4>

                    </Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Textfield name="hrName" label="Name of the HR" />
                  </Grid>

                  <Grid item xs={6}>
                    <Textfield name="hrcontactNo" label="HR Contact number" />
                  </Grid>

                  <Grid item xs={6}>
                    <Textfield name="hrmail" label="Email id" />
                  </Grid>
                  <Grid item xs={12}>
                  ...
                  <Accordion onChange={handleChange}>
                    ...
                    <AccordionDetails>
                      <Grid container spacing={2}>
                        ...
                        <Grid item xs={6}>
                          <Textfield name="jobtitle/designation" label="Job title/ Designation" />
                        </Grid>
                        <Grid item xs={6}>
                          <Textfield name="joiningAndLeavingDate" label="JOining and Leaving Date" />
                        </Grid>
                  ...
                  <Accordion onChange={handleChange}>
                    <AccordionSummary
                      ...
                      id="panel1a-header"
                    >
                      <Typography>Experience 3</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                      <Grid container spacing={2}>
